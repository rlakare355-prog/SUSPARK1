...
$whereConditions = [
    'rp.is_active = 1',
    '(rp.end_date IS NULL OR rp.end_date >= CURDATE())'
];
$params = [];
            ...
            <div class="project-card" data-aos="zoom-in" data-aos-delay="<?php echo ($index % 6) * 100; ?>">
                ...
                <div class="project-header">
                    ...
                    <div class="project-meta">
                        <div class="meta-item">
                            ...
                            <span class="meta-value"><?php echo htmlspecialchars($project['coordinator_first'] . ' ' . $project['coordinator_last_name']); ?></span>
                            <?php else: ?>
                        ...
                        <div class="meta-item">
                            ...
                            <span class="meta-value"><?php echo htmlspecialchars($project['lead_first'] . ' ' . $project['lead_last_name']); ?></span>
                            <?php else: ?>
                            <span class="meta-value">Not Assigned</span>
                            <?php endif; ?>
                        </div>
                ...
                <div class="project-footer">
                    ...
                    <div class="project-dates">
                        ...
                        <?php if ($project['end_date'] && $project['status'] === 'completed'): ?>
                        <div class="date-item">
                            <i class="fas fa-check-circle"></i>
