...
function sendEmail($to, $subject, $body, $attachments = []) {
    $apiKey = getSetting('mailjet_api_key');
    $apiSecret = getSetting('mailjet_api_secret');

    // If Mailjet not configured, use PHP mail as fallback
    ...
    try {
        ...
        return $httpCode === 200 && isset($result['Messages'][0]['Status']) && $result['Messages'][0]['Status'] === 'success';
    } catch (Exception $e) {
